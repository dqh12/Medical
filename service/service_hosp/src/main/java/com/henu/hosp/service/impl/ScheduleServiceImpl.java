...
import com.henu.hosp.mapper.ScheduleMapper;
import com.henu.hosp.repository.ScheduleRepository;
import com.henu.hosp.service.DepartmentService;
import com.henu.hosp.service.HospitalService;
import com.henu.hosp.service.ScheduleService;
import com.henu.model.models.hosp.BookingRule;
...
import com.henu.model.vo.hosp.BookingScheduleRuleVo;
import com.henu.model.vo.hosp.ScheduleOrderVo;
import com.henu.model.vo.hosp.ScheduleQueryVo;
...
public class ScheduleServiceImpl extends
    ...
    public Map<String, Object> getBookingScheduleRule(int page, int limit, String hoscode, String depcode) {
        ...
        if(hospital == null) {
            throw new SumException(ResultCodeEnum.DATA_ERROR);
        }
