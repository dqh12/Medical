...
import com.henu.common.serviceutil.HttpRequestHelper;
import com.henu.common.util.ResultCodeEnum;
import com.henu.common.util.SumException;
import com.henu.hosp.client.HospitalFeignClient;
import com.henu.model.enums.OrderStatusEnum;
import com.henu.model.models.order.OrderInfo;
import com.henu.model.models.user.Patient;
import com.henu.model.vo.hosp.ScheduleOrderVo;
import com.henu.model.vo.msm.MsmVo;
import com.henu.model.vo.order.*;
import com.henu.order.mapper.OrderMapper;
import com.henu.order.service.OrderService;
import com.henu.order.service.WeixinService;
import com.henu.user.client.PatientFeignClient;
...
public class OrderServiceImpl extends
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        if(new DateTime(scheduleOrderVo.getStartTime()).isAfterNow()
            ...
            throw new SumException(ResultCodeEnum.TIME_NO);
        }
        ...
        if(result.getInteger("code")==200) {
            ...
            throw new SumException(result.getString("message"), ResultCodeEnum.FAIL.getCode());
        }
    ...
    public Boolean cancelOrder(Long orderId) {
        ...
        if(quitTime.isBeforeNow()) {
            throw new SumException(ResultCodeEnum.CANCEL_ORDER_NO);
        }
        //调用医院接口实现预约取消
        ...
        if(result.getInteger("code")!=200) {
            ...
            if(orderInfo.getOrderStatus().intValue() == OrderStatusEnum.PAID.getStatus().intValue()) {
                ...
                if(!isRefund) {
                    throw new SumException(ResultCodeEnum.CANCEL_ORDER_FAIL);
                }
                //更新订单状态
