package com.henu.user.service.impl;
...
import com.henu.model.enums.AuthStatusEnum;
...
import com.henu.user.mapper.UserInfoMapper;
import com.henu.user.service.PatientService;
...
public class UserInfoServiceImpl  extends
    ...
    public Map<String, Object> loginUser(LoginVo loginVo) {
        ...
        if(!code.equals(redisCode)) {
            throw new SumException(ResultCodeEnum.CODE_ERROR);
        }
        ...
        if(userInfo.getStatus() == 0) {
            throw new SumException(ResultCodeEnum.LOGIN_DISABLED_ERROR);
        }
