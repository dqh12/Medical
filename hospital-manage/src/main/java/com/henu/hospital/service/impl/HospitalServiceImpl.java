package com.henu.hospital.service.impl;

import com.alibaba.fastjson.JSONObject;
import com.henu.hospital.mapper.OrderInfoMapper;
import com.henu.hospital.mapper.ScheduleMapper;
import com.henu.hospital.model.OrderInfo;
import com.henu.hospital.model.Patient;
import com.henu.hospital.model.Schedule;
...
public class HospitalServiceImpl implements HospitalService {
    ...
    public Map<String, Object> submitOrder(Map<String, Object> paramMap) {
        ...
        if(null == schedule) {
            throw new MedicalException(ResultCodeEnum.DATA_ERROR);
        }
